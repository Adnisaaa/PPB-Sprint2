...
class profil : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val chistoryButton: Button = findViewById(R.id.consulHistoryButton)
        val metopemButton: Button = findViewById(R.id.paymentButton)
        val logtbtn: Button = findViewById(R.id.logoutButton)
